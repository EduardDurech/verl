...
from transformers import AutoModelForCausalLM, LlamaConfig, PretrainedConfig, Qwen2Config, SwissAIConfig
...
def test_configs():
    return [
        ...
        SequenceParallelConfig(SwissAIConfig(num_hidden_layers=2, num_attention_heads=32, num_key_value_heads=32, hidden_size=4096), sp_size=8, is_valid=True),
    ]
